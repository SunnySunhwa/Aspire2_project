...
<?php $sql = "SELECT rooms.*,floor.RoomFloor,floor.id as bid  from rooms join floor on floor.id=rooms.RoomFloor";
$query = $dbh -> prepare($sql);
$query->execute();
$results=$query->fetchAll(PDO::FETCH_OBJ);
$cnt=1;
...
{  ?>
        <div class="product-listing-m gray-bg">
          ...
          <div class="product-listing-content">
            <h5><a href="vehical-details.php?vhid=<?php echo htmlentities($result->id);?>"><?php echo htmlentities($result->RoomFloor);?> , <?php echo htmlentities($result->RoomName);?></a></h5>
            <p class="list-price">$<?php echo htmlentities($result->PricePerDay);?> Per Day</p>
            <ul>
              <li><i class="fa fa-user" aria-hidden="true"></i><?php echo htmlentities($result->Suitable);?> Suitable </li>
