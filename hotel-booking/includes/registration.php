...
if(isset($_POST['signup']))
{
  ...
  $to_email = $_POST['emailid'];
  $subject = 'Thanks you for sign up Aspire2 Hotel Booking System.';
  $message = 'This mail is sent using the PHP mail function in Hotel Booking System.';
  $headers = 'From: noreply@aspire2hotel.com';
