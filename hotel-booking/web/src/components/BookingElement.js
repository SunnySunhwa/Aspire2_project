...
function BookingElement({
  ...
  const startTime = momentTimezone.tz(bookingData.bookingStart, 'Pacific/Auckland').format('h.mma')
  const endTime = momentTimezone.tz(bookingData.bookingEnd, 'Pacific/Auckland').format('h.mma')
