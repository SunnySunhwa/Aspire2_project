...
header('location:index.php');
		...
		$sql="UPDATE VEHICLES SET Vimage2='$vimage2' where id='$id'";
		$rs = $conn->query($sql);
									...
									<div class="panel-body">
										...
										<?php if($msg){?><div class="succWrap"><strong>SUCCESS</strong>:<?php echo $msg; ?> </div><?php }
											...
											<div class="form-group">
												...
												<?php 
												$id=intval($_GET['imgid']);
												$sel ="SELECT Vimage2 from VEHICLES where VEHICLES.id='$id'";
												$result = $conn -> query($sel);
												$cnt=1;
												while($rows = $result->fetch_assoc()){
													?>
													<div class="col-sm-8">
													<img src="img/vehicleimages/<?php echo $rows['Vimage2'];?>" class="edit-image">
													</div>
												<?php }?>
											</div>
